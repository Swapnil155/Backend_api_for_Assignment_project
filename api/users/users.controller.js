...
module.exports = {
    ...
    userRegistration: async (req, res) => {
        ...
        if (isExist) {
            ...
            try {
                ...
                const userInfo = await User.findOne({ _id: userdata._id }).populate('userDetails')
                if (userdata) {
            ...
            if (!userData) {
                ...
                if (userData.user_exist) {
                    ...
                    if (!isMatch) {
                        ...
                        const data = await User.findOne({ _id: userData._id }).populate('userDetails')
    ...
    userResentOtp: async (req, res) => {
        ...
        try {
            ...
            if (isExist) {
                ...
                const updateOtp = await User.findByIdAndUpdate(_id, {
                    $set: { pin: hashOtp }
                }, { new: true })
    ...
    userUploadFiles: async (req, res) => {
        ...
        console.log(JSON.stringify(req.files === null))
            ...
            switch (option) {
                case "personal-details":
                    ...
                    if (!updateEmailDetails) {
                        ...
                        const user_all_Details = await User.findOne({ _id: _id }).populate('userDetails')
                ...
                case "change-password":
                    ...
                    try {
                        ...
                        if (!userData) {
                            ...
                            let isMatch = await bcrypt.compare(body.oldPassword, userData.password)
